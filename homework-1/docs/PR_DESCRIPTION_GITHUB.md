...
> ℹ️ This is the **paste-ready** version of `PR_DESCRIPTION.md` — screenshot links use
> absolute GitHub raw URLs so images render inside the PR body. If you rename the
> branch or repo, update the base URL accordingly.
...
**1. Init `CLAUDE.md`**
![init](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_1_init.png)

**2. Analyse `TASKS.md` for logical contradictions**
![analyze](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_2_analyze.png)

**3. Ask to fix assumptions + design architecture/plan**
![architecture & plan question](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_3_1_arc_plus_plan_ask.png)

**4. Binding decisions locked in**
![decisions made](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_3_2_decisions_made.png)

**5. Resulting architecture & execution plan**
![architecture & plan result](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_3_3_arc_and_plan_result.png)

**6. Implementation**
![coding](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_4_coding.png)

**7. Fixing the demo `.http` requests**
![fixing demo requests](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/claude_5_fixing_demo_http_requests.png)

**8. Preparing the PR & organizing screenshots**
![pr preparation](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/pr_prepare_1_screenshots.png)

### ✅ Application running & verification

**9. Seeding sample data**
![seeding](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/api_1_seeding.png)

**10. Create transactions + check balance**
![add and check balance](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/api_2_add_and_check_balance.png)

**11. Transaction filtering**
![transaction filtering](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/api_2_transaction_filtering.png)

**12. Get transaction by id**
![get transaction](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/api_3_get_transaction.png)

**13. Task 4 additional features (summary / interest / export / rate limiting)**
![additional tasks](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/api_4_additional_tasks.png)

**14. `npm test` — all 42 tests passing**
![tests pass](https://github.com/overgapo/gen-ai-software-engineering/raw/homework-1-submission/homework-1/docs/screenshots/tests_1_tests_pass.png)
